...
export default function OutfitHistoryCard({ imageUrl, wornDate, occasion, href, ariaLabel }: OutfitHistoryCardProps) {
  // const content = (
  ...
  return (
    <Link href={href} aria-label={ariaLabel} className="block text-left rounded-xl ">
      {/* {content} */}
